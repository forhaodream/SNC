...
public class MyRatingBar extends LinearLayout {
     ...
     * 每次点击星星所增加的量是整个还是半个
     */
    private MyRatingBar.StepSize stepSize;
    ...
    public void setStepSize(MyRatingBar.StepSize stepSize) {
    ...
    public MyRatingBar(Context context, AttributeSet attrs) {
        ...
        stepSize = MyRatingBar.StepSize.fromStep(mTypedArray.getInt(R.styleable.RatingBar_stepSize, 1));
                        ...
                        public void onClick(View v) {
                            if (mClickable) {
                                ...
                                if (indexOfChild(v) > fint) {
                                    ...
                                    if (stepSize == MyRatingBar.StepSize.Full) {//如果是满星 就不考虑半颗星了
                                        return;
                                    }
    ...
    public enum StepSize {
        ...
        public static MyRatingBar.StepSize fromStep(int step) {
            for (MyRatingBar.StepSize f : values()) {
                if (f.step == step) {
                    return f;
                }
            }
